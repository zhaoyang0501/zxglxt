                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12 b-r">
		                           <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/payfee/create" method="post">
		                           	<table class='table table-bordered'>
		                           		<thead>
		                           		<tr style="text-align: center;" ><td colspan="6" ><h3>费用录入<h3></h3></td></tr>
		                           		</thead>
		                           		<tbody>
		                           			<tr>
		                           				<td>费用登记单据号</td>
		                           			...
		                           			<tr>
		                           				<td >付款日期</td>
		                           				<td > <input name='paydate' type="text" class="form-control input-group date"></td>
		                           				<td >咨询费</td>
